...
class Config(object):
    ...
    TG_BOT_TOKEN = os.environ.get("5508330369:AAH0n3WlYaljhxGTdPmlTDYb6y9vKKw_qsI")

    # Get from my.telegram.org
    APP_ID = int(os.environ.get("1334759"))

    # Get from my.telegram.org
    API_HASH = os.environ.get("b762e666850c69bdd6d5b410f8ad33f0")
